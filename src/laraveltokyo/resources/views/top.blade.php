        ...
        <figure class="figure container-fluid">
            <div class="container">
                <dl class="m-3 py-5 row justify-content-between">
                    ...
                    <img class="mt-3 object-fit-cover img-thumbnail col-lg-5" src="{{ asset('images/keibaIs.png') }}" alt="競馬ドックとは？">
                </dl>
                <dl class="m-3 py-5 row justify-content-between">
                    ...
                    <img class="mt-3 object-fit-cover img-thumbnail col-lg-5 order-lg-1" src="{{ asset('images/keibaList.png') }}" alt="リスト">
                </dl>
                <dl class="m-3 py-5 row justify-content-between">
                    ...
                    <img class="mt-3 object-fit-cover img-thumbnail col-lg-5 order-lg-2" src="{{ asset('images/graphImage.png') }}" alt="グラフ">
                </dl>
            </div>
        </figure>
    </section>
