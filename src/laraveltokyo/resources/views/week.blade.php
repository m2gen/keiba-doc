...
<body>
    ...
    <div class="container">
        ...
        <h3 class="mb-3 p-1 border-bottom border-black">収支総額：<span class="text-danger h1">+{{ number_format($weekData['totalNum']) }}</span> 円</h3>
        @else
        <h3 class="mb-3 p-1 border-bottom border-black">収支総額：<span class="text-primary h1">{{ number_format($weekData['totalNum']) }}</span> 円</h3>
        @endif
        <div class="container">
