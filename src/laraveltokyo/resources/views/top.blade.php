        ...
        <figure class="figure container-fluid">
            <div class="container">
                <dl class="m-3 py-5 row justify-content-between">
                    <img class="object-fit-cover img-thumbnail col-lg-5 order-lg-2" src="{{ asset('images/keibaIs.png') }}" alt="競馬ドックとは？">
                    <figcaption class="mt-5 col-lg-5 order-lg-1">
                        <dt class="h1 text-dark fw-bold border-bottom border-danger">競馬ドックとは</dt>
                ...
                <dl class="m-3 py-5 row justify-content-between">
                    <img class="object-fit-cover img-thumbnail col-lg-5" src="https://i.imgur.com/hHGklC0.png" alt="オルフェーヴル">
                    <figcaption class="mt-5 text-lg-end col-lg-5">
                        <dt class="h1 text-dark fw-bold border-bottom border-success">収支記録を一覧で表示</dt>
                        <dd class="fs-6 mt-3 fw-bold">
                ...
                <dl class="m-3 py-5 row justify-content-between">
                    <img class="object-fit-cover img-thumbnail col-lg-5 order-lg-2" src="https://i.imgur.com/hHGklC0.png" alt="オルフェーヴル">
                    <figcaption class="mt-5 col-lg-5 order-lg-1">
                        <dt class="h1 text-dark fw-bold border-bottom border-info">グラフで収支を確認</dt>
                        <dd class="fs-6 mt-3 fw-bold">
